...
class EditQuestion extends Component {
    ...
    handleAvatarScucess(res, file, num) {
        ...
        form.select_options[num].image = res.data.url
    ...
    async sumbit() {
        const res = await questionEdit(this.state.form)
        if (res.code === 200) {
    ...
    componentDidMount() {
        ...
        this.editor.create()
        // this.editor.txt.html(this.state.form.short_answer)
    ...
    static getDerivedStateFromProps = (news, olds) => {
        let { type, step, city } = news.obj
        let { props, options } = olds.form

        if (olds.form.id !== news.obj.id) {
            return {
                form: { ...news.obj, type: type + '', step: step + '', options, city: city.split(','), props }
            }
        }
                    ...
                    <Form model={this.state.form} labelPosition={"left"}>
                        ...
                        <div ref="titleMain" className="title-main"></div>
                        {
                            this.state.form.type === '1' ? <Form.Item label="单选">
                                ...
                                <div className="radio-box">
                                    ...
                                    >
                                        {this.state.imageUrl01 ? <img src={this.state.imageUrl01} alt="" style={{ width: "100%" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                                <div className="radio-box">
                                    ...
                                    <Upload
                                        ...
                                        beforeUpload={file => this.beforeAvatarUpload(file)}
                                    >
                                        {this.state.imageUrl02 ? <img src={this.state.imageUrl02} alt="" style={{ width: "100%" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                                <div className="radio-box">
                                    ...
                                    <Upload
                                        ...
                                        beforeUpload={file => this.beforeAvatarUpload(file)}
                                    >
                                        {this.state.imageUrl03 ? <img src={this.state.imageUrl03} alt="" style={{ width: "100%" }} /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                                <div className="radio-box">
                                    ...
                                    <Upload
                                        ...
                                        beforeUpload={file => this.beforeAvatarUpload(file)}
                                    >
                                        {this.state.imageUrl04 ? <img src={this.state.imageUrl04} alt="" style={{ width: "100%" }} /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                                {/* </Radio.Group> */}
                            </Form.Item>
                            ...
                            this.state.form.type === '2' ? <Form.Item label="多选">
                                ...
                                <div className="radio-box">
                                    ...
                                    <Upload
                                        ...
                                        beforeUpload={file => this.beforeAvatarUpload(file)}
                                    >
                                        {this.state.imageUrl03 ? <img src={this.state.imageUrl03} alt="" style={{ width: "100%" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                                <div className="radio-box">
                                    ...
                                    <Upload
                                        ...
                                        beforeUpload={file => this.beforeAvatarUpload(file)}
                                    >
                                        {this.state.imageUrl04 ? <img src={this.state.imageUrl04} alt="" style={{ width: "100%" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                    </Upload>
                                </div>
                            </Form.Item>
                                : null
                        }
                        {
                            ...
                            this.state.form.type === '3' ? <Form.Item label="简单">
                                <br /><br />
                                <div id="edit" style={{ textAlign: "left" }}>
                                    {/* {this.state.form.short_answer} */}
                                    <p dangerouslySetInnerHTML={{ __html: this.state.form.short_answer }}></p>
                                </div>
                            </Form.Item> : null
                        ...
                        <Form.Item label="解析视频地址">
                            ...
                            >
                                {this.state.form.video ? <video src={'/api' + this.state.form.video} controls style={{ width: "244px", height: "176px" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>}
                                {/* {this.state.fo.video ? <video src={'/api'+this.state.form.video} controls style={{ width: "244px", height: "176px" }} className="avatar" /> : <i className="el-icon-plus avatar-uploader-icon"></i>} */}
                            </Upload>
                        </Form.Item>
